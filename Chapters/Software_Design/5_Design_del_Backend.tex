...
Il backend segue un'architettura a strati aperta: ogni layer puó utilizzare le funzionalitá offerte da tutti gli strati sottostanti.
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Figures/object-architecture.png}
    \caption{Backend - layered architecture}
    \label{fig:object-design}
\end{figure}
...
\begin{figure}
    ...
    \caption{GitHub - Metriche di uso delle GitHub Actions}
...
\newline
Di seguito, alcuni dei metodi testati, il grafo del flusso di controllo corrispondente e i test in JUnit.
