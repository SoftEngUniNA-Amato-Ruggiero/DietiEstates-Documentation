...
Questo documento descrive le scelte architetturali e implementative adottate per realizzare il sistema DietiEstates25, illustrando come i requisiti funzionali e non funzionali individuati siano stati tradotti in un'architettura software concreta. \\
Per ogni componente del sistema, vengono fornite le motivazioni delle scelte progettuali, i pattern architetturali applicati e i benefici ottenuti in termini di qualità del codice.

\section{Tipologia di applicazione}
...
Infine, le applicazioni web single page semplificano la logica di frontend, fondamentale per la mappa interattiva.
